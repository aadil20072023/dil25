    ...
    return <section id="about" className="min-h-screen flex items-center justify-center py-20">
        ...
        <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
                ...
                A Full-Stack developer passionate about creating clean, responsive, and user-friendly web experiences. With expertise in modern front-end technologies,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                 <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-5">
                        <li>
                            <strong>Reading Bsc </strong> - Java institute
                        </li>
                 ...
                 <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                        ...
                        <div className="space-y-4 text-gray-300">
                            <div>
                                <h4>Wordpress Developer at Agraze Private Limited (2024-Present)</h4>
                                <p>Developed and Maintained website projects </p>
                            </div>

                            <div>
                                <h4>Graphic Designer at Agraze Private Limited (2024-Present)</h4>
